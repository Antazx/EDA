	...
	public class DesOfuscador2 {
	     ...
	     */
	    public static int buscar(short[] leido, short[] cadena){
	    ...
	    public static void imprimir(short[] txt, int ini, int fin) {
	    ...
	    public static short[] cortar(short[] array, int ini, int tamaño){
	    ...
	    public static void main(String[] args){
	        ...
	        for(i=0; i<65536; i++){
	            ...
	            ofuscado = algoritmo(copia(cadenaA),i);
	            posicion = buscar(leido, ofuscado);
	            if (posicion != -1){
